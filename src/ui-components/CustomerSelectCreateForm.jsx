...
export default function CustomerSelectCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomerSelect(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomerSelectCreateForm")}
      {...rest}
    >
      <SelectField
        label="Customer"
