...
export default function GtoGEDescriptionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setQuarter(initialValues.Quarter);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new GtoGEDescription(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GtoGEDescriptionCreateForm")}
      {...rest}
    >
      <TextField
        label="Company"
