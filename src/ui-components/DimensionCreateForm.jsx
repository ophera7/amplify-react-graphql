...
export default function DimensionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setOverallReadiness(initialValues.OverallReadiness);
    setErrors({});
  };
  const validations = {
    OverallReadiness: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Dimension(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DimensionCreateForm")}
      {...rest}
    >
      <TextField
